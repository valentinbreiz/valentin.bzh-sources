...
import IconLinkedIn from '~icons/ri/linkedin-line';
...
const Title = tw.span`mx-0.5 text-pink-500`;

const Nav = tw.nav`grid gap-3 lg:gap-6 grid-flow-col ml-auto leading-5`;

const navItemStyle = tw`opacity-60 cursor-pointer hover:(opacity-100 text-pink-500)`;
  ...
  return (
    <DarkModeValueContext.Provider value={darkModeEnabled}>
      <Wrapper>
        <Header>
          <HeaderCenter>
            ...
            <Nav>
              ...
              <NavItem href={linkedInUrl} target="_blank">
                <IconLinkedIn />
              </NavItem>
              <NavItem href={twitterUrl} target="_blank">
                <IconTwitter />
              </NavItem>
        ...
        <Footer>
          <FooterCenter>
            <a tw="hover:text-pink-500" href="https://creativecommons.org/licenses/by-nc-sa/4.0/">
              CC BY-NC-SA 4.0
            </a>
            <span tw="ml-2">2023-present © valentinbreiz</span>
          </FooterCenter>
        </Footer>
      </Wrapper>
